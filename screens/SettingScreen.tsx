...
const styles = StyleSheet.create({
  ...
  avatar: { width: 120, height: 120, borderRadius: 60, marginBottom: 12 },
    name: { fontSize: 26, ...typography.semibold, color: '#333', marginBottom: 12, ...typography.regular },
  infoBlock: { marginBottom: 12 },
  infoText: { fontSize: 15, color: '#444', marginBottom: 2, ...typography.regular },
  ...
  updateBtnText: { color: '#fff', ...typography.semibold, fontSize: 16},
  ...
  changePasswordBtnText: { color: '#fff', ...typography.semibold, fontSize: 16 },
  ...
  logoutBtnText: { color: '#fff', ...typography.semibold, fontSize: 16 },
